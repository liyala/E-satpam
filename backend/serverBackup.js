...
app.post("/api/articles", authenticateToken, multiUpload, (req, res) => {
...
app.put("/api/articles/:id/done", authenticateToken, (req, res) => {
  const { id } = req.params;

  const sql = "UPDATE articles SET status = 'done' WHERE id = ?";
